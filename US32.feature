Feature: US32 Uso de nuestra API para gestionar usuarios
    Como desarrollador
...
Scenario: Integrar un API para manejar las solicitudes HTTP de los usuarios y notificaciones
...
Scenario: Manejar errores en la Integración de API para Solicitudes HTTP de usuarios y notificaciones
    Given el desarrollador tiene acceso a la documentación de la API y las credenciales necesarias para realizar la integración
